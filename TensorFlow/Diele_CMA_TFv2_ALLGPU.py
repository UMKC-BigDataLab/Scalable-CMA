...
pd.DataFrame(ICnp).to_csv(outpath + freq_num + '/TFICGPU.csv',header=None,index=None)
pd.DataFrame(DD).to_csv(outpath + freq_num + '/TFDDGPU.csv',header=None,index=None)
