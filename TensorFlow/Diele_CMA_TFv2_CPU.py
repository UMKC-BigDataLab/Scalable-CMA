...
pd.DataFrame(ICnp).to_csv(outpath + freq_num + '/TFICCPU.csv',header=None,index=None)
pd.DataFrame(DD).to_csv(outpath + freq_num + '/TFDDCPU.csv',header=None,index=None)
